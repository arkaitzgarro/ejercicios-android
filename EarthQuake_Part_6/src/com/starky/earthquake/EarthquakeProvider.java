...
public class EarthquakeProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://com.starky.earthquakeprovider/earthquakes");
	...
	public String getType(Uri uri) {
		switch (uriMatcher.match(uri)) {
			case QUAKES:
				return "vnd.android.cursor.dir/vnd.com.starky.earthquakeprovider.earthquake";
			case QUAKE_ID:
				return "vnd.android.cursor.item/vnd.com.starky.earthquakeprovider.earthquake";
			case SEARCH:
